...
export function Services() {
  ...
  >
    ...
    <p className="text-gray-500 text-base leading-relaxed mb-5">
      SoCloud is a leading IT training and solutions provider dedicated to equipping individuals and enterprises with the skills that the modern technology industry demands. We bridge the gap between academic knowledge and real-world application.
    </p>
