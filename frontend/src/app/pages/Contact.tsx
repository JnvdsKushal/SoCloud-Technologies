...
const locations = [
  ...
  // },
  {
    name: "SoCloud Technologies KPHB",
    label: "KPHB Branch",
...
export function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      // POST /api/auth/contact/  → ContactMessageSerializer: name, email, phone, subject, message
      const res = await fetch(`${API_URL}/api/auth/contact/`, {
        ...
        body: JSON.stringify({
          ...
          // phone and subject are optional fields in the serializer
          phone:   '',
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-3">
                <motion.div {...fadeUp(0.18)}>
                  <InfoCard icon={Mail}   label="Email us"      value="socloudtechnologies@gmail.com" href="mailto:socloudtechnologies@gmail.com" />
                </motion.div>
                <motion.div {...fadeUp(0.23)}>
                  <InfoCard icon={Phone}  label="Call us"       value="9133966888 · 9133454949"       href="tel:+919133966888" />
                </motion.div>
                <motion.div {...fadeUp(0.28)}>
                  <InfoCard icon={MapPin} label="Our locations" value="KPHB, Hyderabad" />
                </motion.div>
