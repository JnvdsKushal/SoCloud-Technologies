...
const successStories = [
  ...
  },
  {
    ...
    company: 'Microsoft',
    package: '₹15 LPA',
    testimonial: 'SoCloud not only taught me technical skills but also prepared me for interviews. Forever grateful!',
  },
  {
    name: 'Arjun',
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm font-semibold mb-4">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Why SoCloud
            </div>
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4" style={{ fontFamily: "'Exo 2', sans-serif" }}>
              Why Choose{' '}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-500">SoCloud?</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-400 dark:text-slate-500 max-w-xl mx-auto">
              Real students. Real results. See how SoCloud transformed their careers.
            </p>
          </motion.div>
