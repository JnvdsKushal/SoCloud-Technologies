        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mb-5">
              <img
                src={logo}
                alt="SoCloud Technologies"
                className="h-30 w-50 object-contain object-left"
              />
            </div>

            <p className="text-gray-400 dark:text-slate-500 text-sm mb-2 font-medium">www.socloudtechnologies.com</p>
  ...
  <div className="space-y-6">
    ...
    <div>
      ...
      <ul className="space-y-2 text-sm text-gray-400 dark:text-slate-500">
        ...
        <li className="flex items-center gap-2.5">
          <Mail size={14} className="text-blue-500" />
          <span>socloudtechnologies@gmail.com</span>
        </li>
        ...
        <div className="border-t border-gray-800 dark:border-[#1a2035] pt-7">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500 dark:text-slate-600">
              © {currentYear} SoCloud Technologies. All rights reserved.
            </p>
